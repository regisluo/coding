package com.ttf.A01_tixiban;

import java.util.LinkedList;
import java.util.Queue;
import java.util.Stack;

public class TX10_QuickSort {
    // 荷兰国旗问题
    // make all pivot (here choose the arr[R]) in correct position, thus return the starting and ending index
    ...
    public static void process(int[] arr, int L, int R) {
        ...
        int[] equalIndices = netherlandsFlag(arr, L, R);
